...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func setup3DTouch(app: UIApplication) {
        let actionIcon = UIApplicationShortcutIcon.init(type: .love)
        let actionItem = UIApplicationShortcutItem.init(type: "LoveItem", localizedTitle: "LoveAction", localizedSubtitle: nil, icon: actionIcon, userInfo: nil)
        app.shortcutItems = [actionItem]
    }
